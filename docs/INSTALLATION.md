...
Jobman Diagnose v0.5.0 is the current pre-v1 release. Install Jobman v1.4.0 or
...
The v0.5.0 release provides CGO-free archives for Linux, macOS, and Windows on
amd64 and arm64, plus Linux and Windows 386:

| Platform | Archive |
| --- | --- |
| Linux amd64 | `jobman-diagnose_0.5.0_linux_amd64.tar.gz` |
| Linux arm64 | `jobman-diagnose_0.5.0_linux_arm64.tar.gz` |
| Linux 386 | `jobman-diagnose_0.5.0_linux_386.tar.gz` |
| macOS Intel | `jobman-diagnose_0.5.0_darwin_amd64.tar.gz` |
| macOS Apple silicon | `jobman-diagnose_0.5.0_darwin_arm64.tar.gz` |
| Windows amd64 | `jobman-diagnose_0.5.0_windows_amd64.zip` |
| Windows arm64 | `jobman-diagnose_0.5.0_windows_arm64.zip` |
| Windows 386 | `jobman-diagnose_0.5.0_windows_386.zip` |

Download the archive, checksum manifest, and Sigstore bundle from the [v0.5.0
...
gh release download v0.5.0 \
  ...
  --pattern 'jobman-diagnose_0.5.0_darwin_arm64.tar.gz' \
  --pattern 'jobman-diagnose_0.5.0_checksums.txt' \
  --pattern 'jobman-diagnose_0.5.0_checksums.txt.sigstore.json'
```
...
```console
cosign verify-blob \
  --bundle jobman-diagnose_0.5.0_checksums.txt.sigstore.json \
  --certificate-identity \
    'https://github.com/ryancswallace/Jobman-Diagnose/.github/workflows/release.yml@refs/tags/v0.5.0' \
  --certificate-oidc-issuer https://token.actions.githubusercontent.com \
  jobman-diagnose_0.5.0_checksums.txt
grep '  jobman-diagnose_0.5.0_darwin_arm64.tar.gz$' \
  jobman-diagnose_0.5.0_checksums.txt | shasum -a 256 -c -
gh attestation verify \
  jobman-diagnose_0.5.0_darwin_arm64.tar.gz \
  --repo ryancswallace/Jobman-Diagnose
```
...
```console
tar -xzf jobman-diagnose_0.5.0_darwin_arm64.tar.gz
...
[v0.5.0 release]: https://github.com/ryancswallace/Jobman-Diagnose/releases/tag/v0.5.0
